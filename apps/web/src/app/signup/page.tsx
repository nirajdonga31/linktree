      ...
      <div className="w-full lg:w-1/2 xl:w-[45%] flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[400px]">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 px-4 bg-white border-2 border-[#e0e2d9] rounded-full flex items-center justify-center gap-3 hover:border-[#1e2330] transition disabled:opacity-50 disabled:cursor-not-allowed font-semibold text-[#1e2330]"
          >
